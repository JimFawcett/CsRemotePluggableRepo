 ...
 * --------------------
 * Ver 1.1 : 15 Jul 2017
 * - revised checkout processing to use Dependency defined in Relationships package
 * Ver 1.0 : 31 May 2017
 * - first release
 * 
 */
...
namespace PluggableRepository
{
  ...
  public class Checkout : ICheckout
  {
    ...
    /*----< initialize >-------------------------------------------*/
    /*
     *  RepoEnvironment objects are initialized by Repository.
     *  Running this project in stand-alone mode requires an
     *  explicit construction of RepoEnvironment.checkout.
     */
    public Checkout()
    {
  ...
  public class TestCheckout
  {
    ...
    {
      // nothing to do for this test sequence
    }
